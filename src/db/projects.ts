...
const projects: Project[] = [
  {
    ...
    subtitle: "Movie page",
    description:
      "A movie page that allows users to browse and search for movies using the TMDb API.",
    image: movie,
    technologies: [
      "React",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "An admin panel for managing employees relations, built with a modern UI and various administrative features.",
    image: crm,
    technologies: [
      "React",
      "TypeScript",
  ...
  },
  {
    ...
    subtitle: "e-Commerce",
    description:
      "An e-commerce platform for furniture, allowing users to browse products, view details, and make purchases.",
    image: furniro,
    technologies: [
      "React",
      "JavaScript",
  ...
  },
  {
    ...
    subtitle: "Blog",
    description:
      "A blog platform for sharing articles, featuring a sleek design and multi-language support.",
    image: plast,
    technologies: [
      "React",
      "JavaScript",
  ...
  },
  {
    ...
    subtitle: "e-Commerce",
    description:
      "An e-commerce site for a coffee shop, offering an online shopping experience for various coffee products.",
    image: coffee,
    technologies: [
      "React",
      "JavaScript",
  ...
  },
  {
    ...
    description:
      "A personal blog for a dietitian named Amy, featuring articles on nutrition, healthy eating, and lifestyle tips.",
    image: dietitian,
    technologies: [
      "HTML",
      "CSS",
    ...
    liveLink:
      "https://dietitian-single-page-bootstrap-nazisgs-projects.vercel.app/",
  },
];
